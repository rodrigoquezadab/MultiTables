...
¡Una aplicación web interactiva, moderna y educativa para aprender y dominar las tablas de multiplicar!
...
- **Vanilla CSS** (personalizaciones y transiciones de UI)
- **JavaScript** (lógica del quiz, estadísticas, navegación y persistencia local)

## 🚀 Cómo Empezar

Simplemente abre el archivo `index.html` en cualquier navegador web moderno, ¡y empieza a practicar!
